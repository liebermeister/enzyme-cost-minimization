function [f,u] = fsc_obd(x,v,M_forward,N_forward,log_Keq_forward,kc_forward,km_forward,ind_scored_enzymes,enzyme_cost_weights)
...
f = max(delta_G_by_RT(ind_scored_enzymes));
